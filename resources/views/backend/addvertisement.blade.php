        ...
        <div class="container-fluid" style="padding: 0 10px !important;">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Add Addvertisement </h4>
                </div>
                    ...
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-9 col-md-offset-3">
                                <form action="{{route('addvertisement.store')}}" class="floating-labels" enctype="multipart/form-data" method="post" id="page">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="ads_name">Advertisement Name (Optional)</label>
                                            <input type="text" value="{{old('ads_name')}}"  name="ads_name"  id="ads_name" class="form-control" >
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="adsType"  required="required" id="adsType" class="form-control custom-select">
                                                <option value=""></option>
                                                <option value="google" {{ (old('adsType') =='google') ? 'selected' : '' }}> Google Adsense</option>
                                                <option value="image" {{ (old('adsType') =='image') ? 'selected' : '' }}>Image Ads</option>
                                                <option value="others" {{ (old('adsType') =='others') ? 'selected' : '' }}>Others Ads</option>
                                            </select>
                                        </div>
                                    </div>     
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="page"  required="required" id="page" class="form-control custom-select">
                                                <option value=""></option>
                                                <option value="home" {{ (old('home') =='home') ? 'selected' : '' }}> Home page</option>
                                                <option value="category" {{ (old('category') =='category') ? 'selected' : '' }}>Category page</option> 

                                                <option value="search_page" {{ (old('category') =='category') ? 'selected' : '' }}>Search page</option>

                                                <option value="details_page" {{ (old('details_page') =='details_page') ? 'selected' : '' }}>News Details Page</option> 
                                                
                                                <option value="reporter_page" {{ (old('reporter_page') =='reporter_page') ? 'selected' : '' }}>Reporter page</option> 
                                                
                                                <option value="user_profile" {{ (old('user_profile') =='user_profile') ? 'selected' : '' }}>User profile Page</option>
                                                
                                                <option value="phato_gallery" {{ (old('phato_gallery') =='phato_gallery') ? 'selected' : '' }}>Phato gallery</option>
                                                
                                                <option value="video_gallery" {{ (old('video_gallery') =='video_gallery') ? 'selected' : '' }}>Video gallery</option>

                                                <option value="custom_page" {{ (old('custom_page') =='custom_page') ? 'selected' : '' }}>Custom pages</option>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{old('redirect_url')}}"  name="redirect_url"  id="redirect_url" class="form-control" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{old('clickBtn')}}"   name="clickBtn"  id="clickBtn" class="form-control" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="head-label">
                                            ...
                                            <div class="form-group">
                                                <input type="file" multiple="" name="image" id="input-file-now" class="dropify" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="add_code" class=" form-control" rows="5" id="add_code" placeholder="Enter text ..."></textarea>
                                        </div>
                                    </div>
