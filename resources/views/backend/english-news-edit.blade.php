...
@section('css')
    ...
    .anotherImage{
        position: relative;width: 100% !important;height: 60%; float: left; padding: 5px;
        margin-top: 10px;
        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Update english news </h4>
                </div>
                <div class="col-md-7 align-self-center text-right">
                    <div class="d-flex justify-content-end align-items-center">
                        <a href="{{route('englishNews.list')}}" class="btn btn-info btn-sm d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> News List</a>
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
                                            ...
                                            <div  style="margin-top: 20px; position:relative; padding: 15px; border: 1px solid #e1e1e1">
                                                <label class="dropify_image_area" style="top:-12px;">Keywords</label>
                                                 ...
                                                 <div class="tags-default">
                                                    <input type="text" name="keywords[]" value="{{$get_news->keywords}}"  data-role="tagsinput" placeholder="add tags" />
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input name="publish_date" value="{{$get_news->publish_date}}" required id="datepicker-autoclose" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-12" >
                                            <div class="head-label">
                                                ...
                                                <div  style="padding:0px 1px 13px 40px;">
                                                    <div class="custom-control custom-switch">
                                                      <input name="status" {{ ($get_news->status == '1') ? 'checked' : '' }} type="checkbox" class="custom-control-input" id="status">
