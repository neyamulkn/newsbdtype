...
@section('content')
    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid" style="padding: 0 10px !important;">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{route('page.store')}}" class="floating-labels" enctype="multipart/form-data" method="post" id="page">
                        @csrf
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-9">
                                    <div class="row">
                                       ...
                                       <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="page_dsc" class="form-control" id="mymce" rows="5">{{old('page_dsc')}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="template"  required="required" id="template" class="form-control custom-select">
                                                    <option value="1" {{ (old('template') ==3) ? 'selected' : '' }}>Default Page</option>
                                                    <option value="2" {{ (old('template') ==1) ? 'selected' : '' }}>All News</option>
                                                     <option value="3" {{ (old('template') ==1) ? 'selected' : '' }}>Author List</option>
                                                    <option value="4" {{ (old('template') ==2) ? 'selected' : '' }}>Sitemap</option>
                                        ...
                                        <div class="col-md-12">
                                            <div class="head-label">
                                                ...
                                                <div class="form-group">
                                                    <input type="file" multiple="" name="images[]" id="input-file-now" class="dropify" />
                                                </div>
                                            </div>
                                        </div>
