                                            ...
                                            <tr id="item{{$show_reporter->id}}">
                                                ...
                                                <td>
                                                    <div class="custom-control custom-switch" style="padding-left: 3.25rem;">
                                                      <input name="status" onclick="satusActiveDeactive('{{$show_reporter->id}}')"  type="checkbox" {{($show_reporter['status'] == 1) ? 'checked' : ''}} class="custom-control-input" id="{{$show_reporter->id}}">
                                                ...
                                                <td>
                                                    ...
                                                    <button data-target="#delete" onclick="confirmPopup('{{ $show_reporter->id }}')" class="btn btn-danger btn-sm" data-toggle="modal"><i class="ti-trash" aria-hidden="true"></i> Delete</button>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
