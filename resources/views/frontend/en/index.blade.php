                                            ...
                                            <div class="news-post standard-post2 ">
                                                <a href="{{route('news_details', $section_news->news_slug)}}">
                                                    ...
                                                    <div class="post-title box_title">
                                                        <h2><a href="{{route('news_details', $section_news->news_slug)}}">{{str_limit($section_news->news_title, 90)}} </a></h2>
                                                        <span>{!!str_limit(strip_tags($section_news->news_dsc), 150)!!}</span>
                                            ...
                                            <div class="news-post standard-post2">
                                                <a href="{{route('news_details', $section_news->news_slug)}}">
                                                    ...
                                                    <div class="post-title">
                                                        <h2><a href="{{route('news_details', $section_news->news_slug)}}">{{str_limit($section_news->news_title, 45)}} </a></h2>
                                                        <ul class="post-tags">
                                            ...
                                            <div class="item news-post standard-post">
                                                <a href="{{route('news_details', $special_report->news_slug)}}">
                                                    ...
                                                    <div class="post-content" style="padding: 0px 10px;">
                                                        <h2><a href="{{route('news_details', $special_report->news_slug)}}">{{str_limit($special_report->news_title, 45)}}</a></h2>
                                                        <ul class="post-tags">
                                    ...
                                    <div class="col-md-6">
                                        <div class="item news-post standard-post">
                                            ...
                                            <div class="post-content">
                                                ...
                                                <span>{!!str_limit(strip_tags($world_news->news_dsc), 150)!!}</span>
                                            </div>
                                        </div>
                                    </div>
                                @else
                                    ...
                                    @if($i==1)
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="news-post standard-post2">
                                                ...
                                                <div class="post-title box_title">
                                                    <h2><a href="{{route('news_details', $sport_news->news_slug)}}">{{str_limit($sport_news->news_title, 80)}} </a></h2>
                                                    <span>{!!str_limit(strip_tags($sport_news->news_dsc), 150)!!}</span>
                                                </div>
                                    ...
                                    @else
                                        <div class="col-md-3 col-xs-6 col-sm-3">
                                            <div class="news-post standard-post2">
                                                ...
                                                <div class="post-title">
                                                    <h2><a href="{{route('news_details', $sport_news->news_slug)}}">{{str_limit($sport_news->news_title, 40)}} </a></h2>
                                                    <ul class="post-tags">
                                ...
                                <ul class="list-posts">
                                    @foreach($get_live_tv as $live_tv)
                                        <li>
                                            ...
                                            <div class="post-content">
                                                <h2><a href="{{route('news_details', $live_tv->news_slug)}}">{{str_limit($live_tv->news_title, 60)}}</a></h2>
                                                <ul class="post-tags">
                            ...
                            @foreach($entertainment_news as $show_news)
                                @if($i == 1)
                                    <div class="col-md-6">
                                        ...
                                        <p style="padding-top: 5px">{!!str_limit(strip_tags($show_news->news_dsc), 105)!!}</p>
                                    </div>
                                @else
                                    <div class="col-md-6">
                                        <ul class="list-posts">
                                            <li>
                                                ...
                                                @else @endif
                                                <div class="post-content">
                                                    <h2><a href="{{route('news_details', $show_news->news_slug)}}">{{str_limit($show_news->news_title, 60)}}</a></h2>
                                                    <ul class="post-tags">
                                    ...
                                    <div class="col-md-6">
                                        <ul class="list-posts">
                                            <li>
                                                ...
                                                @else @endif
                                                <div class="post-content">
                                                    <h2><a href="{{route('news_details', $show_news->news_slug)}}">{{str_limit($show_news->news_title, 50)}}</a></h2>
                                                    <ul class="post-tags">
                                ...
                                @if($i == 1)
                                    <div class="col-md-12">
                                        <div class="item news-post standard-post">
                                            ...
                                            <div class="post-content">
                                                <h2><a href="{{route('news_details', $technology_news->news_slug)}}">{{str_limit($technology_news->news_title, 80)}}</a></h2>
                                            </div>
                                        </div>
                                    </div>
                                @else
                                ...
                                @if($i == 1)
                                    <div class="col-md-12">
                                        <div class="item news-post standard-post">
                                            ...
                                            <div class="post-content">
                                                <h2><a href="{{route('news_details', $accidente_news->news_slug)}}">{{str_limit($accidente_news->news_title, 80)}}</a></h2>
                                            </div>
                                        </div>
                                    </div>
                                @else
                                    <div class="col-md-6">
                                        <div class="item news-post standard-post">
                                            ...
                                            <div class="post-content">
                                                <h2><a href="{{route('news_details', $accidente_news->news_slug)}}">{{str_limit($accidente_news->news_title, 50)}}</a></h2>
                                            </div>
                                        </div>
                                    </div>
                                @endif
                                ...
                                @if($i == 1)
                                    <div class="col-md-12">
                                        <div class="item news-post standard-post">
                                            ...
                                            <div class="post-content">
                                                <h2><a href="{{route('news_details', $education_news->news_slug)}}">{{str_limit($education_news->news_title, 80)}}</a></h2>
                                            </div>
                                        </div>
                                    </div>
                                @else
                                    <div class="col-md-6">
                                        <div class="item news-post standard-post">
                                            ...
                                            <div class="post-content">
                                                <h2><a href="{{route('news_details', $education_news->news_slug)}}">{{str_limit($education_news->news_title, 50)}}</a></h2>
                                            </div>
                                        </div>
                                    </div>
                                @endif
                                ...
                                @if($i == 1)
                                    <div class="col-md-12">
                                        <div class="item news-post standard-post">
                                            ...
                                            <div class="post-content">
                                                <h2><a href="{{route('news_details', $health_news->news_slug)}}">{{str_limit($health_news->news_title, 80)}}</a></h2>
                                            </div>
                                        </div>
                                    </div>
                                @else
                                    <div class="col-md-6">
                                        <div class="item news-post standard-post">
                                            ...
                                            <div class="post-content">
                                                <h2><a href="{{route('news_details', $health_news->news_slug)}}">{{str_limit($health_news->news_title, 50)}}</a></h2>
                                            </div>
                                        </div>
                                    </div>
                                @endif
                                                ...
                                                <div class="news-post image-post">
                                                    ...
                                                    <div class="hover-box">
                                                        <div class="inner-hover">
                                                            ...
                                                            <h2><a href="{{route('news_details', $picture_voice->news_slug)}}">{{str_limit($picture_voice->news_title, 50)}}</a></h2>
                        ...
                        @foreach($get_visual_gallery as $visual_gallery)
                            @if($i == 1)
                                <div class="news-post image-post default-size">
                                    ...
                                    <div class="hover-box">
                                        <div class="inner-hover">
                                            <h2><a href="{{route('news_details', $visual_gallery->news_slug)}}">{{str_limit($visual_gallery->news_title, 50)}}</a></h2>
                                        </div>
                                    </div>
                                </div>
                            @else
                                    ...
                                    <div class="col-md-6">
                                        <ul class="list-posts">
                                            <li>
                                                <img src="{{ asset('upload/images/thumb_img/'. $show_news->source_path)}}" alt="">
                                                <div class="post-content">
                                                    <h2><a href="{{route('news_details', $show_news->news_slug)}}">{{str_limit($show_news->news_title, 40)}}</a></h2>
                                                    <ul class="post-tags">
                                    ...
                                    @if($i == 1)
                                        <div class="col-md-12">
                                            <div class="item news-post standard-post">
                                                ...
                                                <div class="post-content">
                                                    <h2><a href="{{route('news_details', $show_news->news_slug)}}">{{str_limit($show_news->news_title, 80)}}</a></h2>
                                                </div>
                                            </div>
                                        </div>
                                    @else
                                ...
                                @if($i == 1)
                                    <div class="col-md-12">
                                        <div class="item news-post standard-post">
                                            ...
                                            <div class="post-content">
                                                <h2><a href="{{route('news_details', $life_style->news_slug)}}">{{str_limit($provash_news->news_title, 80)}}</a></h2>
                                            </div>
                                        </div>
                                    </div>
                                @else
