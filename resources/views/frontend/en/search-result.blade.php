                                        ...
                                        <div class="col-md-3 col-sm-3">
                                            <div class="news-post standard-post2">
                                                <div class="post-gallery">
                                                    <img src="{{ asset('upload/images/thumb_img/'. $search_result->image->source_path)}}" alt="">

                                                </div>
                                                <div class="post-title">
                                                    <h2><a href="{{route('news_details', $search_result->news_slug)}}">{{str_limit($search_result->news_title, 40)}} </a></h2>
                                                    <ul class="post-tags">
