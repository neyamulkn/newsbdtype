										...
										<div class="autor-box">
											<div class="row">
												<div class="col-xs-4 col-sm-2">
													<img src="{{asset('upload/images/users/thumb_image/'. $user->image)}}" alt="{{$user->username}}">
												</div>
												<div class="col-xs-8 col-sm-10">
													<span><a style="color: #fff;font-weight: bold;" href="{{route('user_profile', $user->username)}}">{{$user->name}} </a></span><br/>
													Email: {{$user->email}}<br/>
													Gander: {{($user->gender == 1) ? 'Male' : 'Female'}}<br/>
									...
									<div class="col-md-3 col-sm-4 col-xs-6">
										<div class="item news-post standard-post">
											...
											<div class="post-content">
												<h2><a href="{{route('news_details', $show_news->news->news_slug)}}">{{str_limit($show_news->news->news_title, 70)}} </a></h2>
												<ul class="post-tags">
